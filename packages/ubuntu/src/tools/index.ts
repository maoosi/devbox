import type { GitMode, GitWritePolicy, McpServer, SetupStatus } from "@devbox/core";

export type { GitMode, GitWritePolicy } from "@devbox/core";
...
// What a tool did on this run — core's SetupStatus. The cli loop uses this to
// stamp the spinner (✓ / ↻) and group the end-of-run summary into Installed /
// Reused buckets, so a re-run is visibly different from a first install.
export type ToolStatus = SetupStatus;
