...
> **AI Prompt**: Check if these findings are valid — if so, understand the root cause of each and fix it. If not valid, push back with a one-liner explanation why.
